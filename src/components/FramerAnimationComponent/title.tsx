...
type Props = {
  ...
  id: string;
  colorInView:string;
  colorNotInView:string;
};

export const FeatureTitle = ({ children, id , colorInView , colorNotInView}: Props) => {
  ...
  return (
    <h2
      ...
      className={classNames(
        "feature-title py-20 font-heading text-3xl transition-colors",
        isInView ? `text-${colorInView}  font-semibold` : `text-${colorNotInView}`
      )}
    >
      {children}
    </h2>
