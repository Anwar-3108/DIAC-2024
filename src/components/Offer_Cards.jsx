...
const Offer_Cards = () => {
  ...
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-2 mx-auto lg:block md:block hidden">
          ...
          <div className="mb-10 lg:mb-0 lg:col-span-6 lg:col-start-8 lg:order-2">
            ...
            >
              ...
              >
                <span className="flex">
                  <svg
                    className="flex-shrink-0 mt-2 size-6 md:size-7 hs-tab-active:text-brown text-gray-800 dark:hs-tab-active:text-blue-500 dark:text-gray-200"
      ...
      <div className="relative">
        <div>
          ...
          >
            <img
              ...
              style={{ maxHeight: '500px' }} // Adjust the maximum height here
            />
          </div>
                <div
                  id="tabs-with-card-2"
              ...
              <div className="hidden absolute top-0 end-0 translate-x-20 md:block lg:translate-x-5">
                <svg
                  className="w-16 h-auto text-orange-900"
                  width="121"
                  height="135"
                  viewBox="0 0 121 135"
                  fill="none"
        ...
        <div className="absolute inset-0 grid grid-cols-12 size-full">
          <div className="col-span-full lg:col-span-7 lg:col-start-6  w-full h-5/6 rounded-xl sm:h-3/4 lg:h-full dark:bg-white/[.075]"></div>
        </div>
      </div>
    </div>
  );
