...
import who_we_are_img  from "../assets/images/pages/About/who-we-are-0.1.png";
const WhoWeAre = () => {
  ...
  return (
    <div>
      <section   className="text-white body-font px-4 justify-center align-middle lg:block sm:block md:hidden">
        <div className="container mx-auto flex px-5 py-20 md:flex-row flex-col items-center">
          ...
          >
            <h1 className="title-font sm:text-4xl sm:text-left text-3xl mb-4 font-medium text-black lg:text-left pl-4">
              <span className="text-brown">Who{""} </span>we are ?
