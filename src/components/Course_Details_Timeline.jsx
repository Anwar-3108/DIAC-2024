      ...
      <ol class="relative border-s border-gray-900 dark:border-gray-700">
        <li class="mb-10 ms-6">
          ...
          <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">
            Get access to over 20+ pages including a dashboard layout, charts,<br/>
        ...
        <li class="mb-10 ms-6">
          ...
          <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            All of the pages and components are first designed in Figma and we <br/>
        ...
        <li class="ms-6">
          ...
          <p class="text-base font-normal text-gray-500 dark:text-gray-400">
            Get started with dozens of web components and interactive elements <br/>
...
export default Course_Details_Timeline;
