...
const Panel_Designing_and_AutoCAD = () => {
  ...
  return (
    ...
    <Course_Duration trainingName={"Panel Designing and AutoCAD Training"} />
...
export default Panel_Designing_and_AutoCAD
