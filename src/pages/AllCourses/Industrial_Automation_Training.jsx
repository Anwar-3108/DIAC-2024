...
const Industrial_Automation_Training = () => {
        ...
        <div className="container px-5 py-12 mx-auto flex flex-wrap items-center justify-center">
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:mt-0 mt-10">
            <div className="sm:p-8 p-4">
              ...
              DIAC, the leading institution in automation solutions, offers comprehensive training tailored to industry needs. Our courses, conducted by experienced professionals, cover both theoretical knowledge and hands-on practice with real equipment and simulation software. With a focus on placement, we prepare engineers and diploma holders for lucrative careers in high-end mechanical design and project-based companies. Customized programs are also available to meet specific needs.
              </div>
            </div>
          </div>
        </div>
              ...
              <li class="mb-10 ms-6">
                ...
                <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white">
                  ...
                  <span class="brown-bg text-white text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">
                    We provide you placement assistance
                  </span>
                </h3>
...
export default Industrial_Automation_Training;
